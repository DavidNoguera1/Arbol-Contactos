<%-- 
    Document   : modales
    Created on : 26 feb 2024, 8:33:10
    Author     : PC
--%>
...
<script>
    function confirmarEliminacion(contactName) {
        if (confirm("¿Estás seguro de que deseas eliminar el contacto " + contactName + "?")) {
            // Usuario hizo clic en OK, proceder con la eliminación
            $.ajax({
                type: "GET",
                url: "SvContacto",
            ...
            // Usuario hizo clic en Cancelar, no hacer nada o manejar según corresponda
        }
    }
</script>